...
from backend.presentation.music.http.router import router as music_router
...
from backend.presentation.search.http.router import router as search_router
from backend.presentation.videos.http.router import router as videos_router
